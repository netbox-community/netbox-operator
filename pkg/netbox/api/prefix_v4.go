...
func (c *NetboxClientV4) GetPrefix(ctx context.Context, prefix *models.Prefix) (*nclient.PaginatedPrefixList, error) {
...
func (c *NetboxClientV4) createPrefix(ctx context.Context, prefix *nclient.WritablePrefixRequest) (*nclient.Prefix, error) {
...
func (c *NetboxClientV4) updatePrefix(ctx context.Context, prefixId int32, prefix *nclient.WritablePrefixRequest) (*nclient.Prefix, error) {
...
func (c *NetboxClientV4) DeletePrefix(ctx context.Context, prefixId int32) error {
