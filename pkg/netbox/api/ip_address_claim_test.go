...
func TestIPAddressClaim_GetNoAvailableIPAddressWithNonExistingVrf(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	...
	actual, err := compositeClient.GetAvailableIpAddressByClaim(context.TODO(), &models.IPAddressClaim{
