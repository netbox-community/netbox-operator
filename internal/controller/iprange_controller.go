...
func (r *IpRangeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		if loggingErr := r.EventStatusRecorder.Report(ctx, o, netboxv1.ConditionIpRangeReadyFalse,
			corev1.EventTypeWarning, err, fmt.Sprintf("%s-%s ", o.Spec.StartAddress, o.Spec.EndAddress)); loggingErr != nil {
